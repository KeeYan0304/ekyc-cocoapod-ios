...
class CameraView: UIView {
    ...
    private let flashOnImg = UIImage(named: "flash_on_icon", in: Bundle(for: CameraView.self), compatibleWith: nil)
    private let flashOffImg = UIImage(named: "flash_off_icon", in: Bundle(for: CameraView.self), compatibleWith: nil)
    private let flip_image = UIImage(named: "warning_icon", in: Bundle(for: CameraView.self), compatibleWith: nil)
    private let capture_image = UIImage(named: "warning_icon", in: Bundle(for: CameraView.self), compatibleWith: nil)
    ...
    private func commonInit() {
        let sdkBundle = Bundle(for: CameraView.self)
        sdkBundle.loadNibNamed("CameraView", owner: self, options: nil)
